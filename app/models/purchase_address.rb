class PurchaseAddress
  ...
  def save
    ...
    Address.create(postalcode: postalcode, prefecture_id: prefecture_id, city: city, streetaddress: streetaddress, buildingname: buildingname, phonenumber: phonenumber, purchase_id: purchase.id)
  end
end